...
function onLocationFound(e) {
    ...
    if (!userMarker) {
        userMarker = L.marker(userLocation, { icon: L.icon({ iconUrl: 'beam-geolocation-icon.png', iconSize: [25, 41] }) }).addTo(map)
        ...
        routingControl.spliceWaypoints(routingControl.getWaypoints().length - 1, 1, userLocation);
    }
